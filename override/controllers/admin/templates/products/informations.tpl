...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="provenance">
			<span class="label-tooltip" data-toggle="tooltip"
			title="{l s='Your internal reference code for this product.'} {l s='Allowed special characters:'} .-_#\">
				{$bullet_common_field} {l s='Provenance'}
			</span>
		</label>
		<div class="col-lg-5">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="producteur">
			<span class="label-tooltip" data-toggle="tooltip"
			title="{l s='Your internal reference code for this product.'} {l s='Allowed special characters:'} .-_#\">
				{$bullet_common_field} {l s='Producer'}
			</span>
		</label>
		<div class="col-lg-5">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="alcool">
			<span class="label-tooltip" data-toggle="tooltip"
			title="{l s='Your internal reference code for this product.'} {l s='Allowed special characters:'} .-_#\">
				{$bullet_common_field} {l s='Alcohol'}
			</span>
		</label>
		<div class="col-lg-5">
	...
	<div class="form-group">
		<label class="control-label col-lg-3" for="sucre">
			<span class="label-tooltip" data-toggle="tooltip"
			title="{l s='Your internal reference code for this product.'} {l s='Allowed special characters:'} .-_#\">
				{$bullet_common_field} {l s='Sugar'}
			</span>
		</label>
		<div class="col-lg-5">
	...
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="note_degustation" type="tinymce" multilang="true"}</span></div>
		...
		<div class="col-lg-9">
			{include
				...
				languages=$languages input_name='note_degustation'
				class="autoload_rte"
				input_value=$product->note_degustation}
		</div>
	</div>
